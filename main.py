...
modelConfiguration = 'TNK-M9-PRO-C68-PCP-BP-main/.gitignore'
modelWeights = 'TNK-M9-PRO-C68-PCP-BP-main/yolov3.weights'

labelsPath = 'TNK-M9-PRO-C68-PCP-BP-main/coco.names'

labels = open(labelsPath).read().strip().split('\n')

yoloNetwork = cv2.dnn.readNetFromDarknet(modelConfiguration, modelWeights)

video = cv2.VideoCapture("TNK-M9-PRO-C68-PCP-BP-main/car.mp4")
